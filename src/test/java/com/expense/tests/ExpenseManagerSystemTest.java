...
public class ExpenseManagerSystemTest {
	...
	public void afterTest(ITestResult result) throws Exception {
        ...
        if(result.getStatus() == ITestResult.FAILURE) {
        	...
        	BasicCredentials cred = new BasicCredentials("elvisinofuente@gmail.com", "V@leri@2013");
			
			//You need to enter your JIRA machine IP address with port 8080 in below line
        	JiraClient jira = new JiraClient("http://ec2-18-117-127-128.us-east-2.compute.amazonaws.com:8080/", cred);
